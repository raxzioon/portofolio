...
export const Hero: React.FC = () => {
  ...
  return (
    <section 
      id="home" 
      className="relative h-[100dvh] min-h-[100dvh] sm:h-auto sm:min-h-screen flex flex-col justify-center items-center pt-16 pb-3 sm:pt-28 sm:pb-16 px-4 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center flex flex-col items-center w-full my-auto">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900/90 border border-blue-500/30 text-[10px] sm:text-xs text-blue-300 mb-2 sm:mb-3 backdrop-blur-md shadow-[0_0_15px_rgba(44,103,237,0.25)]"
        >
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-5xl md:text-6xl font-extrabold uppercase tracking-tight text-white mb-1.5 sm:mb-2 font-['Space_Grotesk',sans-serif] leading-tight"
        >
        ...
        <motion.div
          ...
          className="min-h-[26px] sm:min-h-[38px] flex items-center justify-center mb-2 sm:mb-3 px-2 text-center"
        >
          <span className="text-xs sm:text-xl font-medium text-slate-300 flex items-center flex-wrap justify-center">
            Seorang{' '}
        ...
        <motion.p
          ...
          className="max-w-xs sm:max-w-xl text-[11px] sm:text-sm text-slate-300/85 leading-relaxed mb-3 sm:mb-6 px-1 sm:px-0 mx-auto"
        >
          {personalData.bio}
        </motion.p>
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-2 w-full">
            ...
            <a
              href="#contact"
              onClick={scrollToContact}
              className="py-2 sm:py-2.5 px-3 rounded-full bg-blue-950/40 hover:bg-blue-900/40 text-blue-300 font-medium text-[11px] sm:text-xs uppercase tracking-wide border border-blue-500/25 hover:border-blue-400/40 flex items-center justify-center gap-1.5 active:scale-95 transition-all duration-300"
            >
              <FileDown className="w-3 h-3 text-cyan-300" />
              <span>Unduh CV</span>
            </a>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="flex items-center justify-center gap-2.5 sm:gap-3 text-[11px] sm:text-xs text-slate-400 pt-2 sm:pt-4 border-t border-blue-500/15 w-full max-w-xs sm:max-w-md"
        >
          ...
          <a
            ...
            className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-slate-900/85 border border-blue-500/30 text-slate-300 hover:text-white hover:border-cyan-400 hover:shadow-[0_0_10px_rgba(44,103,237,0.5)] flex items-center justify-center active:scale-95 transition-all"
            aria-label="Telepon"
            title="Telepon"
          >
